...
const comethard = {
  arena: { width: 1500, height: 2500 },
	...
	playerSpawn: { x: 0, y: 0 },
	name: 'CoMETHard',
	longName: 'Comet of Mini Extra Tests Hard',
  bgColor: '#9e391c',
  tileColor: '#cc6243',
  difficulty: "Moderate",
    addedObstacles: [],
...
let { texts, obstacles, safes, spawns, playerSpawn, arena } = comethard;
obstacles.push(new NormalObstacle(0, 100, 75, 50));
obstacles.push(new CircularNormalObstacle(100, 125, 50));
obstacles.push(new Lava(130, 240, 70, 50));
...
obstacles.push(new WB(750, 0, 50, 20, 100, 200))
obstacles.push(new Lava(600, 400, 350, 100));
obstacles.push(new Lava(875, 125, 25, 25));
...
obstacles.push(new Lava(0, 800, 600, 50));
obstacles.push(new NormalObstacle(150, 749, 250, 2));

obstacles.push(new GravObstacle(250, 200, 275, 250, 'right', 1000));
obstacles.push(new VinetteIncrease(250, 200, 275, 250, 0.1, 0.3, 1.8));
obstacles.push(new Lava(8750, 125, 25, 25));

obstacles.push(new Lava(600, 400, 350, 100));
obstacles.push(new Lava(950, 200, 300, 300));
obstacles.push(new Lava(1250, 300, 200, 200));
obstacles.push(new Lava(600, 750, 900, 400, false, false));
...
safes.push(new Safe(550, 760, 240, 10, true));
safes.push(new Safe(800, 760, 10, 90, true));
safes.push(new Safe(800, 850, 185, 10, true));
safes.push(new Safe(1000, 820, 185, 10, true));
safes.push(new Safe(1200, 790, 185, 10, true));
safes.push(new Safe(1400, 790, 10, 500, true));
safes.push(new Safe(750, 1000, 0, 200, true));
safes.push(new Safe(450, 1000, 285, 0, true));

obstacles.push(new MovingTpObstacle(50, 50, [[1300, 1000], [1450, 1000]], 150, 0, 25, 25));

obstacles.push(new TimeTrap(750, 1150, 450, 350, 1.5));
...
obstacles.push(new Lava(100, 1175, 100, 50));
...
obstacles.push(new SpeedObstacle(0, 1700, 700, 800, 1.8));
safes.push(new Safe(0, 1700, 50, 50, true))
...
obstacles.push(new GravObstacle(450, 1900, 50, 400, 'down', 5000))

module.exports = comethard;